...
API_PRETURN_HDR PhidgetMotorPositionController_setTargetBrakingStrength(PhidgetMotorPositionControllerHandle ch, double targetBrakingStrength);
API_PRETURN_HDR PhidgetMotorPositionController_getTargetBrakingStrength(PhidgetMotorPositionControllerHandle ch, double *targetBrakingStrength);
